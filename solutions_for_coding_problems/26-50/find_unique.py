...
print("Array=[6, 1, 3, 3, 3, 6, 6]. The integer which only occurs once is: {}".format(find_unique([6, 1, 3, 3, 3, 6, 6])))
print("Array=[13, 19, 13, 13]. The integer which only occurs once is: {}".format(find_unique([13, 19, 13, 13])))