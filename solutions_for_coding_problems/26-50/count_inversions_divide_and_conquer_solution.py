...
'''
The solution provided in count_inversions_brute_force_solution.py runs in O(N^2). It is possible to use a faster solution. 
...
How can we count the inversions between A and B in linear time? 

If we expand our count_inversions function (in count_inversions_brute_force_solution.py) to also sort the array as well, we can use a similar technique to merge sort to merge and also count the inversions between A and B. To be specific,
